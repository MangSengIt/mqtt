...
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,b){a.raw=b;return a};var __private_css="\n:root {\n    --color-primary: #409eff;\n    --color-success: #67c23a;\n    --color-warning: #e6a23c;\n    --color-error: #f56c6c;\n    --color-info: #909399;\n    --current-color: var(--color-primary);\n    --hide-delay: 2s;\n}\n#yuyayuya-alter {\n    background-color: var(--current-color);\n    width: 320px;\n    box-sizing: border-box;\n    font-size: 15px;\n    line-height: 20px;\n    padding: 12px 6px;\n    color: #fff;\n    border-radius: 4px;\n    position: fixed;\n    top: 20px;\n    left: calc(50vw - 160px);\n    z-index: 999999;\n    text-align: center;\n    cursor: default;\n    animation: yuyayuya-alter 0.4s ease-in-out,\n        yuyayuya-alter-hide 0.4s ease-in-out var(--hide-delay) forwards;\n}\n@keyframes yuyayuya-alter {\n    0% {\n        opacity: 0;\n        transform: translateY(-20px);\n    }\n    100% {\n        opacity: 1;\n        transform: translateY(0);\n    }\n}\n@keyframes yuyayuya-alter-hide {\n    0% {\n        opacity: 1;\n        transform: translateY(0);\n    }\n    100% {\n        opacity: 0;\n        transform: translateY(-20px);\n        display: none;\n    }\n}";
CONNECT_MQTT_OPTIONS.tooltip&&document.head.insertAdjacentHTML("beforeend","<style>"+__private_css+"</style>");function __showTooltip(a,b,d){b=void 0===b?"success":b;d=void 0===d?3E3:d;var c=document.getElementById("yuyayuya-alter");c&&c.remove();c=document.createElement("div");c.id="yuyayuya-alter";c.innerHTML=a;c.style.setProperty("--current-color","var(--color-"+b+")");c.style.setProperty("--hide-delay",d+"ms");document.body.appendChild(c)}var _MQ_CLIENT=mqtt.connect(CONNECT_MQTT_OPTIONS.url,CONNECT_MQTT_OPTIONS.options);
_MQ_CLIENT.on("error",function(a){CONNECT_MQTT_OPTIONS.tooltip&&__showTooltip("connect Error["+CONNECT_MQTT_OPTIONS.url+"]: "+a.toString(),"error");console.error("Connection failed:",a)});
_MQ_CLIENT.on("connect",function(){CONNECT_MQTT_OPTIONS.tooltip&&__showTooltip(CONNECT_MQTT_OPTIONS.url+" Connected successfully!");CONNECT_MQTT_OPTIONS.subs.forEach(function(a){_MQ_CLIENT.subscribe(a,function(b){b?(console.error("subscribe["+a+"] error: ",b),CONNECT_MQTT_OPTIONS.tooltip&&__showTooltip("subscribe ["+a+"] error: "+b.toString(),"error")):CONNECT_MQTT_OPTIONS.tooltip&&__showTooltip("subscribe ["+a+"] success!")})})});_MQ_CLIENT.on("message",CONNECT_MQTT_OPTIONS.messageCallback);